...
export function generateSampleData(): { cycles: Cycle[]; observationsByCycle: Map<number, Observation[]> } {
  ...
  const c1Obs: Array<Partial<Observation> & { dayOffset: number; stamp: StampType }> = [
    ...
    { dayOffset: 8, mucusStretch: '4', frequency: 'x1', stamp: 'green', intercourse: true },
    { dayOffset: 9, mucusStretch: '4', frequency: 'x2', stamp: 'green' },
    ...
    { dayOffset: 17, mucusStretch: '0', frequency: 'x1', stamp: 'green', intercourse: true },
    { dayOffset: 18, mucusStretch: '0', frequency: 'x1', stamp: 'green' },
    { dayOffset: 19, mucusStretch: '0', frequency: 'x1', stamp: 'green' },
    { dayOffset: 20, mucusStretch: '0', frequency: 'x1', stamp: 'green', intercourse: true },
  ...
  const c2Obs: Array<Partial<Observation> & { dayOffset: number; stamp: StampType }> = [
    ...
    { dayOffset: 6, mucusStretch: '0', frequency: 'x1', stamp: 'green' },
    { dayOffset: 7, mucusStretch: '0', frequency: 'x1', stamp: 'green' },
    { dayOffset: 8, mucusStretch: '0', frequency: 'x1', stamp: 'green', intercourse: true },
    { dayOffset: 9, mucusStretch: '0', frequency: 'x1', stamp: 'green' },
    { dayOffset: 10, mucusStretch: '4', frequency: 'x1', stamp: 'green' },
    { dayOffset: 11, mucusStretch: '4', frequency: 'x2', stamp: 'green' },
    { dayOffset: 12, mucusStretch: '6', mucusCharacteristics: ['C'], frequency: 'x2', stamp: 'whiteBaby' },
    ...
    { dayOffset: 16, mucusStretch: '0', frequency: 'x1', stamp: 'greenBaby1', intercourse: true },
    { dayOffset: 17, mucusStretch: '6', mucusCharacteristics: ['C'], frequency: 'x1', stamp: 'whiteBaby2' },
    { dayOffset: 18, mucusStretch: '0', frequency: 'x1', stamp: 'greenBaby3' },
    { dayOffset: 19, mucusStretch: '0', frequency: 'x1', stamp: 'green' },
